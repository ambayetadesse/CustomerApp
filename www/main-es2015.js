...
module.exports = __webpack_require__(/*! D:\MTK Project\Mtk-Delivery-API\CustomerApp\src\main.ts */"zUnb");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, router, alertCtrl, modalService) {
...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | signup-customer-signup-customer-module */[__webpack_require__.e("default~signup-customer-signup-customer-module~user-user-module"), __webpack_require__.e("common"), __webpack_require__.e("signup-customer-signup-customer-module")]).then(__webpack_require__.bind(null, /*! ./signup-customer/signup-customer.module */ "Tftg")).then(m => m.SignupCustomerPageModule)
    },
    {
        path: 'customer-option',
        loadChildren: () => Promise.all(/*! import() | customer-option-customer-option-module */[__webpack_require__.e("default~customer-option-customer-option-module~order-order-module"), __webpack_require__.e("common"), __webpack_require__.e("customer-option-customer-option-module")]).then(__webpack_require__.bind(null, /*! ./customer-option/customer-option.module */ "UZRK")).then(m => m.CustomerOptionPageModule)
    },
    {
        path: 'message',
