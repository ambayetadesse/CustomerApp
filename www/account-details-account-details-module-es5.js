        ...
        _createClass(AccountDetailsPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.accountService.getAllAccount().subscribe(function (res) {
              _this.locationId = res.find(function (c) {
                return c.id == +id;
              }).Location;
              _this.active = res.find(function (c) {
                return c.id == +id;
              }).active;
              _this.type = res.find(function (c) {
                return c.id == +id;
              }).type;
          ...
          value: function SaveAccount() {
            ...
            this.accountService.updateAccount(data).subscribe(function (res) {// alert(res.toString());
            });
