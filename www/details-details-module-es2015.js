...
let DetailsPage = class DetailsPage {
    constructor(foodService, Activatedroute, restaurantservice, categoryService, router, modalCtrl, orderService, sharedService, alertController, toastController, document) {
