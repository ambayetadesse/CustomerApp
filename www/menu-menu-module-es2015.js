...
const routes = [
    {
        ...
        children: [
            {
                path: 'order',
                loadChildren: () => Promise.all(/*! import() | order-order-module */[__webpack_require__.e("default~customer-option-customer-option-module~order-order-module"), __webpack_require__.e("order-order-module")]).then(__webpack_require__.bind(null, /*! ../order/order.module */ "+p+5")).then(m => m.OrderPageModule)
            },
            {
                path: 'location',
            ...
            {
                path: 'details/:id',
                loadChildren: () => Promise.all(/*! import() | details-details-module */[__webpack_require__.e("default~cart-modal-cart-modal-module~details-details-module"), __webpack_require__.e("common"), __webpack_require__.e("details-details-module")]).then(__webpack_require__.bind(null, /*! ../details/details.module */ "QR/W")).then(m => m.DetailsPageModule)
            },
            {
                path: 'home',
            ...
            {
                path: 'cart-modal',
                loadChildren: () => Promise.all(/*! import() | cart-modal-cart-modal-module */[__webpack_require__.e("default~cart-modal-cart-modal-module~details-details-module"), __webpack_require__.e("cart-modal-cart-modal-module")]).then(__webpack_require__.bind(null, /*! ../cart-modal/cart-modal.module */ "pUdO")).then(m => m.CartModalPageModule)
            },
            {
                path: 'login',
            ...
            {
                path: 'order-history',
                loadChildren: () => __webpack_require__.e(/*! import() | order-history-order-history-module */ "order-history-order-history-module").then(__webpack_require__.bind(null, /*! ../order-history/order-history.module */ "piv+")).then(m => m.OrderHistoryPageModule)
            },
            {
                path: 'profile',
